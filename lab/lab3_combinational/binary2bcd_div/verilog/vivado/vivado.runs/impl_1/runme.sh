...
HD_PWD='/media/sf_lab/lab3_combinational/binary2bcd_div/verilog/vivado/vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log binary2bcd.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source binary2bcd.tcl -notrace
